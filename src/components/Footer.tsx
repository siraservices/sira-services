            ...
            <div className="space-y-3">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="block text-sm text-text-muted hover:text-primary transition-colors duration-200 cursor-pointer"
                >
                  {link.label}
                </Link>
              ))}
            ...
            <div className="flex gap-3">
              {[
                ...
                <a
                  ...
                  className="p-2.5 rounded-lg bg-surface text-text-muted hover:text-primary hover:bg-surface-hover transition-all duration-200 cursor-pointer"
