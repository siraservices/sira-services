    ...
    <div className="py-16 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose max-w-none">
          ...
          <h2 className="text-2xl font-bold text-gray-100 mt-12 mb-4">Background</h2>
          ...
          <h2 className="text-2xl font-bold text-gray-100 mt-12 mb-4">What I Bring</h2>
          <p className="text-gray-300 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-100 mt-12 mb-4">Technical Focus</h2>
          <p className="text-gray-300 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-100 mt-12 mb-4">Approach</h2>
          <p className="text-gray-300 mb-4">
        ...
        <div className="mt-12 pt-8 border-t border-[#333]">
          <h3 className="text-xl font-semibold text-gray-100 mb-4">Ready to work together?</h3>
          <Link
            href="/contact"
